...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: _objectSpread(_objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_0__.mapActions)("auth", ["submit"])), (0,vuex__WEBPACK_IMPORTED_MODULE_0__.mapMutations)(["CLEAR_ERRORS"])), {}, {
    login: function login() {
      ...
      this.submit(this.loginForm).then(function () {
        if (_this.isAuth) {
          _this.CLEAR_ERRORS();
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.loginFrom.remember_me,
                          expression: "loginFrom.remember_me",
                        },
                      ],
                      attrs: { type: "checkbox", id: "remember" },
                      domProps: {
                        checked: Array.isArray(_vm.loginFrom.remember_me)
                          ? _vm._i(_vm.loginFrom.remember_me, null) > -1
                          : _vm.loginFrom.remember_me,
                      },
                      on: {
                        change: function ($event) {
                          var $$a = _vm.loginFrom.remember_me,
                            $$el = $event.target,
                          ...
                          if (Array.isArray($$a)) {
                            ...
                            _vm.$set(_vm.loginFrom, "remember_me", $$c)
                          }
                        },
                      },
                    }),
